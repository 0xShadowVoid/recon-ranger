...
TOOL_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "interactsh": {
        ...
        "binary": "interactsh-client",
        "apt": None,
        "description": "Out-of-band interaction server",
        "example": "interactsh-client",
    },
    "anew": {
        "type": "go",
        ...
        "example": "cat new.txt | anew existing.txt",
    },
    "uro": {
        "type": "go",
    ...
    "aidor": {
        "type": "git",
        "repo": "https://github.com/gwen001/aidor.git",
        "path": "/opt/aidor",
        "binary": "aidor",
        "entrypoint": "/opt/aidor/aidor.py",
        "requirements": ["-r", "/opt/aidor/requirements.txt"],
        "description": "Asset discovery tool",
        "example": "python3 aidor.py -d target.com",
    },
    "cvinder": {
        "type": "git",
        "repo": "https://github.com/0x4D5A/cvinder.git",
        "path": "/opt/cvinder",
        "binary": "cvinder",
        "entrypoint": "/opt/cvinder/cvinder.py",
        "requirements": ["-r", "/opt/cvinder/requirements.txt"],
        "description": "CVE scanner",
        "example": "python3 cvinder.py -t target.com",
    },
    "sqlmap": {
        "type": "git",
        "repo": "https://github.com/sqlmapproject/sqlmap.git",
        ...
        "binary": "sqlmap",
        "entrypoint": "/opt/sqlmap/sqlmap.py",
        "requirements": ["-r", "/opt/sqlmap/requirements.txt"],
        "description": "SQL injection testing tool",
        "example": "python3 sqlmap.py -u https://target.com",
    },
    "reconftw": {
        "type": "git",
