...
> One-command installer for 20+ professional recon tools (subfinder, amass, nuclei)  
...
| `core/config.py` | 180 | All 20 tool definitions |
...
| Command | Description |
|---------|-------------|
| `sudo python3 reconranger.py --all` | Install all 20 tools with progress bar |
